 ...
 *
 * - Validates email format and password presence on submit
 * - Calls loginUser API → stores JWT via AuthContext
 * - Redirects to /dashboard on success
 * - Shows toast on error (invalid credentials, network issue)
